...
namespace UdemyAuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async  Task<Response<TokenDto>> CreateTokenAsync(LoginDto loginDto)
        {
            ...
            {
                await _userRefreshTokenService.AddAysync(new UserRefreshToken { UserId = user.Id, Code = token.RefreshToken, Expiration = token.RefreshTokenExpration });
        ...
        //refresh token null yapucagız veritanında
